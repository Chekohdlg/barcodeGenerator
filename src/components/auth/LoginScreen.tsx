      ...
      <div className="w-full max-w-md">
        <div className="bg-surface-800 rounded-2xl p-8 shadow-2xl border border-surface-700">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-foreground">BarcodeGenerator</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoComplete="email"
                className="w-full bg-surface-700 border border-surface-600 text-foreground rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent placeholder-zinc-600"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-brand-500 hover:bg-brand-600 disabled:opacity-50 disabled:cursor-not-allowed text-foreground font-medium rounded-lg py-2.5 text-sm transition-colors"
            >
